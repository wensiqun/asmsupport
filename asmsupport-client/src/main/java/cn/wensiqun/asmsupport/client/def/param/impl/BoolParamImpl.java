 ...
 *
 */
public class BoolParamImpl extends PriorityParam implements BoolParam {
	
    public BoolParamImpl(BlockTracker blockTracker, OperatorAction action, Param... operands) {
