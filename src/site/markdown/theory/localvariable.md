...
![](http://asmsupport.github.io/images/theory_LocVar_1.png)<br/>

如果按照程序流程执行，很显然这里会有两种执行结果。分别是当bool为真的时候执行if语句块，当bool为false执行else语句块。如下图就是这两种情况的局部变量图

![](http://asmsupport.github.io/images/theory_LocVar_2.png)<br/>
...
![](http://asmsupport.github.io/images/theory_LocVar_3.png)<br/>
图1
...
![](http://asmsupport.github.io/images/theory_LocVar_4.png)<br/>
图2
...
![](http://asmsupport.github.io/images/theory_LocVar_5.png)<br/>
图3
...
![](http://asmsupport.github.io/images/theory_LocVar_6.png)<br/>
图5
