...
public class KernelGreaterEqual extends NumericalRelational {
    ...
    protected KernelGreaterEqual(ProgramBlockInternal block, KernelParameterized factor1, KernelParameterized factor2) {
        super(block, factor1, factor2, Operators.GREATER_THAN_OR_EQUAL_TO);
    }
