...
public abstract class AbstractNullCompareRelational extends NumericalAndReferenceRelational {
	...
	protected AbstractNullCompareRelational(KernelProgramBlock block, KernelParameterized factor1, KernelParameterized factor2, Operator operator) {
	...
	protected boolean isNullValue(KernelParameterized val){
