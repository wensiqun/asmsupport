...
public class KernelShortCircuitAnd extends ConditionOperator implements Jumpable {
    ...
    protected KernelShortCircuitAnd(ProgramBlockInternal block, KernelParameterized factor1, KernelParameterized factor2) {
        super(block, factor1, factor2, Operators.CONDITION_AND);
    }
