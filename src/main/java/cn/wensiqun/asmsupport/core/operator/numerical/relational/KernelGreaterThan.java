...
public class KernelGreaterThan extends NumericalRelational {
    ...
    protected KernelGreaterThan(ProgramBlockInternal block, KernelParameterized factor1, KernelParameterized factor2) {
        super(block, factor1, factor2, Operators.GREATER_THAN);
    }
