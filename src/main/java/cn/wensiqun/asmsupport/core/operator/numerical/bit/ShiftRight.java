 ...
 *
 */
public class ShiftRight extends BinaryBitwise {

    protected ShiftRight(ProgramBlockInternal block, InternalParameterized factor1, InternalParameterized factor2) {
