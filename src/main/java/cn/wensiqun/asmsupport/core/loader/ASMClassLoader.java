 ...
 * <h3>Release notes</h3>
 * <ul>
 * <li><b>version 0.4</b> : Thanks for "aruanruan at vip.sina.com"(oschina
 * account "aruan") suggestion. for detail see <a
 * href="http://code.taobao.org/p/asmsupport/issue/31553/"
 * >http://code.taobao.org/p/asmsupport/issue/31553/</a></li>
 * </ul>
 * 
...
public class ASMClassLoader extends ClassLoader {
    ...
    public final Class<?> defineClass(String name, byte[] b) throws SecurityException, NoSuchMethodException,
            IllegalArgumentException, IllegalAccessException, InvocationTargetException {

        Method method = ClassLoader.class.getDeclaredMethod("defineClass", new Class[] { String.class, byte[].class,
                int.class, int.class });
