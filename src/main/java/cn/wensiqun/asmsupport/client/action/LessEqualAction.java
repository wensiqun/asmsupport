...
public class LessEqualAction extends OperatorAction {

    public LessEqualAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.le(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
