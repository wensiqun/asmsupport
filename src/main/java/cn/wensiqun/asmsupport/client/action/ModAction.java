...
public class ModAction extends OperatorAction {

    public ModAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.mod(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
