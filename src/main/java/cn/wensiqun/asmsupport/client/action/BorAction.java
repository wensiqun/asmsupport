...
public class BorAction extends OperatorAction {

    public BorAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.bor(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
