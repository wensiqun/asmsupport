...
public class AndAction extends OperatorAction {

    public AndAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.and(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
