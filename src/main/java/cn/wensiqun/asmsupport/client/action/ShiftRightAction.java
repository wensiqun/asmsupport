...
public class ShiftRightAction extends OperatorAction {

    public ShiftRightAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.shr(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
