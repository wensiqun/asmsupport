...
public class MulAction extends OperatorAction {

    public MulAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.mul(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
