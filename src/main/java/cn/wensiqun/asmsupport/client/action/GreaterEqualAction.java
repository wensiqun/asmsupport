...
public class GreaterEqualAction extends OperatorAction {

    public GreaterEqualAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.ge(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
