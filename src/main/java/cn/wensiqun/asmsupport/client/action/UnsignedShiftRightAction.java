...
public class UnsignedShiftRightAction extends OperatorAction {

    public UnsignedShiftRightAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.ushr(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
