...
public class DivAction extends OperatorAction {

    public DivAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.div(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
