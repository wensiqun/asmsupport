...
public class EqualAction extends OperatorAction {

    public EqualAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.eq(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
