...
public class ShiftLeftAction extends OperatorAction {

    public ShiftLeftAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.shl(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
