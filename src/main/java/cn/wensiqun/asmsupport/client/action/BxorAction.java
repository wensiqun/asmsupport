...
public class BxorAction extends OperatorAction {

    public BxorAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.bxor(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
