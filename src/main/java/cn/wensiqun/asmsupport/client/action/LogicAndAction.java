...
public class LogicAndAction extends OperatorAction {

    public LogicAndAction(ProgramBlockInternal block) {
    ...
    public Param doAction(ArrayStack<Param> operands) {
        ...
        return new DummyParam(block.logicalAnd(ParamPostern.getTarget(fac1), ParamPostern.getTarget(fac2)));
    }
