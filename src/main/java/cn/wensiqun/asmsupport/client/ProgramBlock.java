...
public class ProgramBlock<B extends ProgramBlockInternal> implements ActionSet<IF , While, DoWhile, ForEach, Try, Synchronized>
{
    ...
    @Override
    public LocalVariable arrayVarWithDimension(String name, ArrayClass aClass, boolean anonymous,
        Parameterized... allocateDim)
    {
        return target.arrayVarWithDimension(name, aClass, anonymous, allocateDim);
    }

    @Override
    public LocalVariable arrayVar(String name, ArrayClass aClass, boolean anonymous, Parameterized value)
    {
        return target.arrayVar(name, aClass, anonymous, value);
    }

    @Override
    public LocalVariable arrayVar(String name, ArrayClass aClass, boolean anonymous,
    ...
    @Override
    public ShortCircuitAnd and(Parameterized factor1, Parameterized factor2, Parameterized... otherFactor)
    {
        return target.and(factor1, factor2, otherFactor);
    }

    @Override
    public ShortCircuitOr or(Parameterized factor1, Parameterized factor2, Parameterized... otherFactor)
    {
