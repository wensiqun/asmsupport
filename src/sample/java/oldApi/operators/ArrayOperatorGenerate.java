	...
	public static void main(String[] args) {
		...
		creator.createStaticMethod(Opcodes.ACC_PUBLIC + Opcodes.ACC_STATIC, "main", new AClass[]{AClassFactory.getType(String[].class)}, new String[]{"args"}, null, null,
			...
			public void body(LocalVariable... argus) {
				 ...
				 */
				//s2[0]
				KernelParameterized arrayLoader = arrayLoad(s2, Value.value(0));
				 ...
				 * System.out.println("new value of s2 is : " + ArrayUtils.toString(s2));
				 */
				arrayStore(s2, newarray((ArrayClass) AClassFactory.getType(String[].class), new KernelParameterized[]{Value.value("new s2[0][0]"), Value.value("new s2[0][1]")}), Value.value(0));
