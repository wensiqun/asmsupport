	...
	public static void main(String[] args) {
		...
		creator.createStaticMethod(Opcodes.ACC_PUBLIC, "main", new AClass[]{AClassFactory.defType(String[].class)}, new String[]{"args"}, null, null,
			...
			public void body(LocalVariable... argus) {
	        	...
	        	call(systemOut, "println", stradd(Value.value("boolean default value is : "), Value.defaultValue(AClassFactory.defType(boolean.class))));
	        	
	        	
	        	call(systemOut, "println", stradd(Value.value("byte value is : "), Value.value(byteVal)));
	        	call(systemOut, "println", stradd(Value.value("byte default value is : "), Value.defaultValue(AClassFactory.defType(byte.class))));
	        	
	        	
	        	call(systemOut, "println", stradd(Value.value("short value is : "), Value.value(shortVal)));
	        	call(systemOut, "println", stradd(Value.value("short default value is : "), Value.defaultValue(AClassFactory.defType(short.class))));
	        	

	        	call(systemOut, "println", stradd(Value.value("char value is : "), Value.value(charVal)));
	        	call(systemOut, "println", stradd(Value.value("char default value is : "), Value.defaultValue(AClassFactory.defType(char.class))));


	        	call(systemOut, "println", stradd(Value.value("int value is : "), Value.value(intVal)));
	        	call(systemOut, "println", stradd(Value.value("int default value is : "), Value.defaultValue(AClassFactory.defType(int.class))));


	        	call(systemOut, "println", stradd(Value.value("float value is : "), Value.value(floatVal)));
	        	call(systemOut, "println", stradd(Value.value("float default value is : "), Value.defaultValue(AClassFactory.defType(float.class))));


	        	call(systemOut, "println", stradd(Value.value("long value is : "), Value.value(longVal)));
	        	call(systemOut, "println", stradd(Value.value("long default value is : "), Value.defaultValue(AClassFactory.defType(long.class))));


	        	call(systemOut, "println", stradd(Value.value("double value is : "), Value.value(doubleVal)));
	        	call(systemOut, "println", stradd(Value.value("double default value is : "), Value.defaultValue(AClassFactory.defType(double.class))));
	        	

	        	call(systemOut, "println", stradd(Value.value("String value is : "), Value.value(strVal)));
	        	call(systemOut, "println", stradd(Value.value("double default value is : "), Value.defaultValue(AClassFactory.defType(String.class))));
